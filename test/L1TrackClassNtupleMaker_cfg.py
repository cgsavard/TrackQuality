...
import os
process = cms.Process("L1TrackClassNtuple")
...
process.TTTracksEmulationWithTruthWithClass = cms.Path(process.offlineBeamSpot*L1TRK_PROC*process.TrackTriggerAssociatorTracks*process.TrackClassifier)
...
process.L1TrackClassNtuple = cms.EDAnalyzer('L1TrackClassNtupleMaker',
...
process.ana = cms.Path(process.L1TrackClassNtuple)
...
process.schedule = cms.Schedule(process.TTTracksEmulationWithTruthWithClass,process.ana)
